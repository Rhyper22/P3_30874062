...
const recaptcha = new Recaptcha('6LddoGwpAAAAAC4fn5pc6xW34D7PVeqlqG-z0Rd9','6LddoGwpAAAAALJUbJZkYK4ERM045IQfg8-n1Eqw');
...
//-------------------------------------------------------
app.get('/clientico',verifyToken,(req, res) => {
...
baseDatos.mostrarPaginaProductos(req,res);
})
//-------------------------------------------------------
