...
const db = new sqlite3.Database('./database/database.db', (err) => {
    ...
    db.run('CREATE TABLE IF NOT EXISTS Productos (id INTEGER PRIMARY KEY AUTOINCREMENT, Nombre TEXT, Codigo TEXT, Precio TEXT, Descripcion TEXT, FCardiaca TEXT, DRecorrida TEXT, Correo TEXT, categoria_id INTEGER, FOREIGN KEY (categoria_id) REFERENCES categorias(id))');
